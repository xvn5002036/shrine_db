    ...
    try {
        ...
        $stmt = $pdo->prepare("
            ...
            SET name = ?, type_id = ?, price = ?, duration = ?, 
                description = ?, sort_order = ?, status = ?, updated_at = CURRENT_TIMESTAMP
            WHERE id = ?
        ");

        $stmt->execute([
            $name, $type_id, $price, $duration, 
            $description, $sort_order, $status, $id
        ]);
                ...
                <form method="POST" class="needs-validation" novalidate>
                        ...
                        <select class="form-select" id="type_id" name="type_id" required>
                            ...
                            <?php foreach ($blessing_types as $type): ?>
                                <option value="<?php echo $type['id']; ?>" 
                                        <?php echo $service['type_id'] === $type['id'] ? 'selected' : ''; ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="sort_order" name="sort_order" 
                               value="<?php echo $service['sort_order']; ?>" min="0" step="10">
