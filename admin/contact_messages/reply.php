...
try {
    ...
    error_log('Error handling message reply: ' . $e->getMessage());
...
<head>
    ...
    <title>回覆訊息 - <?php echo SITE_NAME; ?></title>
        ...
        <main class="admin-main">
            ...
            <div class="content">
                <div class="content-header">
                    <h2>回覆訊息</h2>
                    <a href="view.php?id=<?php echo $message['id']; ?>" class="btn btn-secondary">
                        ...
                        <div class="original-message">
                            ...
                            <div class="message-details">
                                <div class="detail-group">
                                    <label>寄件者</label>
                                    <div><?php echo htmlspecialchars($message['name']); ?> &lt;<?php echo htmlspecialchars($message['email']); ?>&gt;</div>
                                </div>
                                <div class="detail-group">
                                    <label>主旨</label>
